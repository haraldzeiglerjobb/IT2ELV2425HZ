...
vaerdata = {
  "lat":59.97,"lon":10.78,"timezone":"Europe/Oslo","timezone_offset":7200,
  "daily": [
    { 
      "dt":1649329200,
      "sunrise":1649305463,
...
#Print out weather data for one given time instance
...
#velfg windgust fra en lister over valgmuligheter

#Vegle dag 3 og se soloppgavensgtiden

dag3 = vaerdata["daily"][2]
solopp_dag3 = dt.datetime.fromtimestamp(dag3["sunrise"])

#ukedag = dt.datetime.weekday(solopp_dag3)
print("sol opp dag 3: ",solopp_dag3)
sol3 = str(solopp_dag3)
print(solopp_dag3.strftime("%d.%m.%Y"))
#sol3.split("-")
print(sol3[:4])
#print(solopp_dag3)
